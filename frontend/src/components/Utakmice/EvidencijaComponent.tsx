...
const EvidencijaComponent = () => {
    ...
    const [evidencijaUtakmice, setEvidencijaUtakmice] = useState<EvidencijaUtakmice>({
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8080/api/v1/utakmice/' + id, evidencijaUtakmice);
            ...
            <form className="evidencija-form" onSubmit={handleSubmit}>
                <div className="timovi">
                    ...
                    <div className="gost">
                        ...
                        <label>
                            Broj postignutih golova:
                            <input type="number" name="brojGolovaGosta" onChange={handleChange}/>
                        </label>
                        <br/>
                    </div>
                </div>
